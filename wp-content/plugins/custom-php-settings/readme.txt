...
This plugin is developed by [Cyclonecode](https://profiles.wordpress.org/cyclonecode) and can be used to customize php settings for you wordpress installation.

The plugin will modify either the **.htaccess** file or **wp-admin/.user.ini** file in order to change the current php settings directly from within the settings page.
...
You can check the name of you custom INI file in the **PHP Information** table. The custom INI file should be placed under the **wp-admin** folder and **most** be **writable** by the webserver.

...
class Flexy_Breadcrumb_Trail {
	...
	public function fbc_page_trail() {
		...
		if ( $post->post_parent ) {
			...
			if ( get_query_var( 'paged' ) > 1 || get_query_var( 'page' ) > 1 ) {
				...
				// Current page
				echo'<li itemprop="itemListElement" itemscope itemtype="' . esc_url( "http://schema.org/ListItem" ) . '"><a itemprop="item" href="' . esc_url( get_permalink() ) . '"><span itemprop="name">' . $this->fbc_limit_strings( esc_attr( get_the_title() ), $fbc_limit_style = 'word', $fbc_text_limit, $fbc_end_text ) . '</span></a><meta itemprop="position" content="' . $counter . '" /></li>';
				$this->fbc_pagination_trail();
			} else {
	...
	public function fbc_cpt_terms_trail() {
		...
		if ( $post_type != 'post' ) {
			...
			if ( !empty( $ancestors ) ) {
				...
				if ( $ancestors ) {
					foreach ( $ancestors as $ancestor ) {
						...
						echo '<li item-parent itemprop="itemListElement" itemscope itemtype="' . esc_url( "http://schema.org/ListItem" ) . '"><a itemprop="item" cpt-term="' . esc_attr( $term_id ) . '" href="' . esc_url( get_term_link( $ancestor ) ) . '" title="' . esc_attr( $term->name ) . '"><span itemprop="name">' . $this->fbc_limit_strings( esc_attr( $term->name ), $fbc_limit_style, $fbc_text_limit, $fbc_end_text ) . '</span></a><meta itemprop="position" content="' . $counter . '" /></li>';
						echo $separator_template;
					}
				}
			}
			...
			if ( get_query_var( 'paged' ) > 1 || get_query_var( 'page' ) > 1 ) {
				...
				// Current Page
				echo '<li class="item-current item-archive" itemprop="itemListElement" itemscope itemtype="' . esc_url( "http://schema.org/ListItem" ) . '"><a itemprop="item" cpt-term="' . esc_attr( $term_id ) . '" href="' . esc_url( get_term_link( $term_id ) ) . '" title="' . esc_attr( $current_tax_name ) . '"><span itemprop="name">' . $this->fbc_limit_strings( esc_attr( $current_tax_name ), $fbc_limit_style, $fbc_text_limit, $fbc_end_text ) . '</span></a><meta itemprop="position" content="' . $counter . '" /></li>';
				$this->fbc_pagination_trail();
			} else {
	...
	public function fbc_post_archive_trail() {
		...
		if ( get_query_var( 'paged' ) > 1 || get_query_var( 'page' ) > 1 ) {
			...
			// Current Page
			echo '<li class="item-current item-archive" itemprop="itemListElement" itemscope itemtype="' . esc_url( "http://schema.org/ListItem" ) . '"><a href="' . get_post_type_archive_link( $post_type ) . '" title="' . esc_attr( post_type_archive_title( '', '' ) ) . '">' . post_type_archive_title( '<span itemprop="name">', '' ) . '</span></a><meta itemprop="position" content="2" /></li>';
			$this->fbc_pagination_trail();
		} else {

			// Current Page
			echo '<li class="active item-current item-archive" itemprop="itemListElement" itemscope itemtype="' . esc_url( "http://schema.org/ListItem" ) . '"><a itemprop="item" href="' . esc_url( $current_url ) . '" title="' . esc_attr( get_the_title() ) . '">' . post_type_archive_title( '<span itemprop="name">', '' ) . '</span></a><meta itemprop="position" content="2" /></li>';
		}
	}
		...
		elseif ( $post_type = 'post' ) {
			...
			if ( 'post-category' == $fbc_settings_options['post_hierarchy'] ) {
				...
				if ( $parent ):
					...
					$cat_trail = '<li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem"><span itemprop="name" title="Category Name">' . $cat_link . '</span><meta itemprop="position" content="' . $counter++ . '" /></li>' . $separator_template;
					...
					foreach ( $child_categories as $chi ):
						if( in_array($chi->term_id, $selected_parents) || $chi->term_id == $selected_node->term_id ):
							...
							$cat_trail .= '<li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem"><span itemprop="name" title="' . $child_cat . '">' . $cat_link . '</span><meta itemprop="position" content="' . $counter++ . '" /></li>' . $separator_template;
						endif;
					endforeach;
					echo $cat_trail;					
				endif;
			...
			if ( 'post-tags' == $fbc_settings_options['post_hierarchy'] ) {
				...
				if ( $tags ) {
					...
					echo '<li itemprop="itemListElement" itemscope itemtype="' . esc_url( "http://schema.org/ListItem" ) . '"><span itemprop="name">' . implode( ', ', $tag_link ) . '</span><meta itemprop="position" content="' . $counter++ . '" /></li>';
					echo $separator_template;
				}
			}
	...
	public function fbc_day_archive_trail() {
		...
		// Year link
		echo '<li itemprop="itemListElement" itemscope itemtype="' . esc_url( "http://schema.org/ListItem" ) . '"><a itemprop="item" href="' . esc_url( get_year_link( get_the_time( 'Y' ) ) ) . '" title="' . esc_attr( get_the_time( 'Y' ) ) . '"><span itemprop="name">' . esc_attr( get_the_time( 'Y' ) ) . '</span></a><meta itemprop="position" content="' . $counter++ . '" /></li>';
		echo $separator_template;

		// Month link
		echo '<li itemprop="itemListElement" itemscope itemtype="' . esc_url( "http://schema.org/ListItem" ) . '"><a itemprop="item" href="' . esc_url( get_month_link( get_the_time( 'Y' ), get_the_time( 'm' ) ) ) . '" title="' . esc_attr( get_the_time( 'M' ) ) . '"><span itemprop="name">' . esc_attr( get_the_time( 'F' ) ) . '</span></a><meta itemprop="position" content="' . $counter++ . '" /></li>';
		echo $separator_template;

		if ( get_query_var( 'paged' ) > 1 || get_query_var( 'page' ) > 1 ) {
			// Day
			echo '<li itemprop="itemListElement" itemscope itemtype="' . esc_url( "http://schema.org/ListItem" ) . '" class="item-' . esc_attr( get_the_time( 'j' ) ) . '"><a itemprop="item" href="' . esc_url( get_day_link( $year, $month, $day ) ) . '" title="' . esc_attr( get_the_time( 'M' ) ) . '"><span itemprop="name">' . esc_attr( get_the_time( 'j' ) ) . '</span></a><meta itemprop="position" content="' . $counter++ . '" /></li>';
			$this->fbc_pagination_trail();
		} else {
			echo '<li itemprop="itemListElement" itemscope itemtype="' . esc_url( "http://schema.org/ListItem" ) . '" class="active item-current item-' . esc_attr( get_the_time( 'j' ) ) . '"><a itemprop="item" href="' . esc_url( $current_url ) . '" title="' . esc_attr( get_the_title() ) . '"><span itemprop="name">' . esc_attr( get_the_time( 'j' ) ) . '</span></a><meta itemprop="position" content="' . $counter++ . '" /></li>';
		}
	}
	...
	public function fbc_yearly_archive_trail() {
		...
		if ( get_query_var( 'paged' ) > 1 || get_query_var( 'page' ) > 1 ) {
			...
			// Year link
			echo '<li class="active" itemprop="itemListElement" itemscope itemtype="' . esc_url( "http://schema.org/ListItem" ) . '" class="item-current item-' . esc_attr( get_the_time( 'Y' ) ) . '"><a itemprop="item" href="' . esc_url( $current_url ) . '" title="' . esc_attr( get_the_title() ) . '"><span itemprop="name">' . esc_attr( get_the_time( 'Y' ) ) . '</span></a><meta itemprop="position" content="' . $counter++ . '" /></li>';
		}
	}
	...
	public function fbc_monthly_archive_trail() {
		...
		// Year link
		echo '<li itemprop="itemListElement" itemscope itemtype="' . esc_url( "http://schema.org/ListItem" ) . '"><a itemprop="item" href="' . esc_url( get_year_link( get_the_time( 'Y' ) ) ) . '" title="' . esc_attr( get_the_time( 'Y' ) ) . '">' . esc_attr( get_the_time( 'Y' ) ) . '</a><meta itemprop="position" content="' . $counter++ . '" /></li>';
		echo $separator_template;
	...
	public function fbc_author_page_trail() {
		...
		if ( get_query_var( 'paged' ) > 1 || get_query_var( 'page' ) > 1 ) {
			...
			echo '<li itemprop="itemListElement" itemscope itemtype="' . esc_url( "http://schema.org/ListItem" ) . '" class="active item-current-' . esc_attr( $author_data->user_nicename ) . '"><a itemprop="item" href="' . esc_url( $current_url ) . '" title="' . esc_attr( get_the_title() ) . '"><strong><span itemprop="name">' . esc_html__( 'Author: ', 'flexy-breadcrumb' ) . $this->fbc_limit_strings( esc_attr( $author_data->display_name ), $fbc_limit_style, $fbc_text_limit, $fbc_end_text ) . '</span></strong></a><meta itemprop="position" content="' . $counter++ . '" /></li>';
		}
	}
	...
	public function fbc_404() {
		...
		echo '<li itemprop="itemListElement" itemscope itemtype="' . esc_url( "http://schema.org/ListItem" ) . '" class="active item-current"><a itemprop="item" href="' . esc_url( $current_url ) . '" title="' . esc_attr( get_the_title() ) . '"><span itemprop="name">' . esc_html__( 'Error 404', 'flexy-breadcrumb' ) . '</span></a><meta itemprop="position" content="2"></li>';
	}
	...
	public function fbc_page_post_trail() {
		...
		if ( get_query_var( 'paged' ) > 1 || get_query_var( 'page' ) > 1 ) {
			...
			// Current Page
			echo '<li class="active" itemprop="itemListElement" itemscope itemtype="' . esc_url( "http://schema.org/ListItem" ) . '"><a itemprop="item" href="' . esc_url( $current_url ) . '" title="' . esc_attr( get_the_title() ) . '">';

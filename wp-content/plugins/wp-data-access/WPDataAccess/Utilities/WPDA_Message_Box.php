	...
	class WPDA_Message_Box {
		...
		public function box() {
			...
			<div id='<?php echo esc_attr( $msgbox_id ); ?>'
				class='updated <?php echo esc_attr( $this->message_type ); ?> <?php echo esc_attr( $this->message_is_dismissible ); ?>'>
				<p>
					<?php echo esc_attr( $this->message_hint ); ?>: <?php echo wp_kses_data( $this->message_text ); ?>
				</p>
			</div>
